                    ...
                    {citas.citas.map(cita => (
                        <div key={cita.id} className="media mt-3">
                            <div className="media-body">
                                <h3 className="mt-0"><span>Nombre Paciente: </span>{cita.paciente}</h3>
                                <p className="card-text"><span>Nombre Doctor: </span>     {cita.doctor}</p>
                                <p className="card-text"><span>Fecha:</span> {cita.fecha}</p>
                                <p className="card-text"><span>Hora:</span> {cita.hora} </p>
                                <p className="card-text"><span>Sintomas del Paciente: </span> <br /> 
                                {cita.sintomas}
                                </p>
                                <button 
