...
const AgregarCita = () => {
    ...
    const submitNuevaCita = e => {
        ...
        if( paciente.trim() === '' || doctor.trim() === '' || fecha.trim() === '' || hora.trim() === '' || sintomas.trim() === '' ) {
                    ...
                    <div className="form-group row">
                        ...
                        <div className="col-sm-8 col-lg-10">
                            <input 
                                ...
                                value={paciente}
                                onChange={ e => guardarPaciente(e.target.value) }
                            />
                        </div>
                    </div>
                    <div className="form-group row">
                        ...
                        <div className="col-sm-8 col-lg-10">
                            <input 
                                type="text" 
                                className="form-control"  
                                placeholder="Nombre Dueño de la Doctor"
                                value={doctor}
                                onChange={ e => guardarDoctor(e.target.value) }
                            />
                        </div>
                    </div>
